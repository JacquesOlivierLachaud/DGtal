...
#include "DGtal/geometry/curves/estimation/MinCircumcircleCurvatureEstimator.h"
			      ...
			      double h )
{
  ...
  if ( ! ok )
    ...
    try {
      ...
      if (gridcurve.isOpen())
        { 
          typedef MinCircumcircleCurvatureEstimator<ClassicIterator> CurvatureEstimator;
	  ...
	  std::cout << "# open grid curve" << endl;
        ...
        { 
          typedef MinCircumcircleCurvatureEstimator<CircularIterator> CurvatureEstimator;
	  CurvatureEstimator estimator;
